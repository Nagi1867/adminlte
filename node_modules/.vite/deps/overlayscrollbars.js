...
var createObserversSetup = (t2, n2, o2, s2) => {
  ...
  const [H2] = createCache({
    ...
    const s3 = x2 && x2.R(t2, n2, C2, $2, o2).Y;
    const e3 = y2 && w2;
    ...
    return addEventListener(h2, "pointerdown", ((o3) => {
      ...
      if (x2) {
        ...
        const k2 = [addEventListener(p2, n3, releasePointerCapture), addEventListener(p2, "selectstart", ((t4) => preventDefault(t4)), {
          T: false
        }), addEventListener(h2, n3, releasePointerCapture), D2 && addEventListener(h2, "pointermove", ((t4) => C3(A2 + (t4[s3] - $3)))), D2 && (() => {
...
var createScrollbarsSetup = (t2, n2, o2, s2, e2, c2) => {
  ...
  return [() => bind(runEachAndClear, push(M2, O2())), ({ zt: t3, It: n3, Qt: e3, Zt: c3 }) => {
    ...
    const { cn: S3, j: m3 } = s2;
    const [O3, C3] = t3("showNativeOverlaidScrollbars");
